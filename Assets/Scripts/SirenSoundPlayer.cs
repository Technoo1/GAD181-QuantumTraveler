...
namespace FT
{
    public class SirenSoundPlayer : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                SirenSFX.Play();
                OnlyPlayOnceL2 = true; //So this SFX only can be played once when difficultyL2 is true.
            }

            if (OnlyPlayOnceL3 == false && TimeCheckSFX.difficultyL3 == true)
            {
                SirenSFX.Play();
                OnlyPlayOnceL3 = true; //So this SFX only can be played once when difficultyL3 is true.
            }
        }
    }
}