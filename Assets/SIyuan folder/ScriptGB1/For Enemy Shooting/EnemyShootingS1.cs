...
namespace S1
{
    public class EnemyShootingS1 : MonoBehaviour
    {
        ...
        public ForwardAndBackward DirectionCheck;  //Call from EnemyMovement script to check face direction.
        ...
        public void Update()
        {
            ...
            if (DirectionCheck.movementTimer < 3.0f)
            {
                EnemyleftCheck = true;
                EnemyrightCheck = false;
            }
            else if (DirectionCheck.movementTimer > 3.0f)
            {
